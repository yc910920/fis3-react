                            ...
                            <div className="logo-background" temp=".0.1.1.0.0">
                                <svg width="100%" height="100%" viewbox="0 0 403 359" version="1.1" temp=".0.1.1.0.0.0">
                                    <g temp=".0.1.1.0.0.0.0">
                                        ...
                                        id="Shape" fill="#515151" temp=".0.1.1.0.0.0.0.0">
                                        </path>
                                        ...
                                        id="Shape" fill="#EB4949" temp=".0.1.1.0.0.0.0.1">
                                        </path>
                                        <circle id="Oval" fill="#FFFFFF" cx="201" cy="179.6" r="35.9" temp=".0.1.1.0.0.0.0.2">
                                        </circle>
                                        ...
                                        id="Shape" fill="#FFFFFF" temp=".0.1.1.0.0.0.0.3">
                                        </path>
                                    </g>
                                </svg>
                            </div>
