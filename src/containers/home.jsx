                        ...
                        <Row>
                            ...
                            <Col span="8">
                                <div className="text-logo">
                                    <div className="small-header-text">Proven, Expert</div>
                                    <div className="big-header-text">
                                        <span>
                                            <span>React Training</span><sup>™</sup>
                                        </span>
                                    </div>
                                    <div className="tagline">From the creators of React Router</div>
                                </div>
                            </Col>
                            <Col span="8"></Col>
                        </Row>
